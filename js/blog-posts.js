...
const BLOG_POSTS = [
  {
    ...
    content: `
      ...
      <p>The field tends to ask: "How can AI assist more efficiently?" I'd like us to ask instead: "Who decides what counts as help?" That shift — from optimization to governance, from efficiency to accountability — is what distinguishes Care AI from AI-with-good-intentions.</p>
